...
class WaveformFusion(torch.nn.Module):
    def __init__(self, channels=2):  
        super(WaveformFusion, self).__init__()
        
        self.ConvBlock1 = torch.nn.Sequential(
            torch.nn.Conv1d(channels, 16, 7, stride=1, padding=3, padding_mode='reflect'),
        ...
        self.ConvBlock2 = torch.nn.Sequential(
            torch.nn.Conv1d(16, 32, 7, stride=1, padding=3, padding_mode='reflect'),
        ...
        self.ConvBlock3 = torch.nn.Sequential(
            torch.nn.Conv1d(32, 64, 7, stride=1, padding=3, padding_mode='reflect'),
        ...
        self.ConvBlock4 = torch.nn.Sequential(
            torch.nn.Conv1d(64, 64, 7, stride=1, padding=3, padding_mode='reflect'),
            torch.nn.BatchNorm1d(64),
            torch.nn.ELU(inplace=True),
            torch.nn.Dropout1d(0.2),
        )
        ...
        self.ConvBlock6 = torch.nn.Sequential(
            torch.nn.Conv1d(64, 32, 7, stride=1, padding=3, padding_mode='reflect'),
            torch.nn.BatchNorm1d(32),
            torch.nn.ELU(inplace=True),
            torch.nn.Dropout1d(0.2),
        )
        ...
        self.ConvBlock7 = torch.nn.Sequential(
            torch.nn.Conv1d(32, 16, 7, stride=1, padding=3, padding_mode='reflect'),
            torch.nn.BatchNorm1d(16),
            torch.nn.ELU(inplace=True),
            torch.nn.Dropout1d(0.2),
        )
        ...
        self.ConvBlock10 = torch.nn.Sequential(
            torch.nn.Conv1d(16, 1, 1, stride=1, padding=0)
        )
